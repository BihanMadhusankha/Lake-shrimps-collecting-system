...
var VehicaleOwnerDashboard = function () {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { className: "dashboard-container" },
            ...
            React.createElement("header", { className: "header" },
                React.createElement("h1", null, "Vehicle Owner Dashboard")),
            React.createElement("div", { className: "top-section" },
                React.createElement(Link, { to: '/SSABS/vehicaleOwn/profile' },
                    React.createElement("button", { className: "top-box top-box-1" }, "Edit Profile")),
                React.createElement(Link, { to: '/SSABS/vehicaleOwn/allpost' },
                    React.createElement("button", { className: "top-box top-box-2" }, "Uploaded Vehicle")),
                React.createElement(Link, { to: '/SSABS/vehicaleOwn/products' },
                    React.createElement("button", { className: "top-box top-box-3" }, "Register Vehicle"))),
