...
const Dashboard: React.FC = () => {
  ...
  const [contentData, setContentData] = useState<Users[]>([]);
  const navigate = useNavigate();

  useEffect(() => {
    const checkTokenValidity = async () => {
      try {
        const response = await axios.get('http://localhost:5001/SSABS/admin/dashboard', {
          headers: {
  ...
  const roles = Object.keys(groupedByCategory);
  const totals = roles.map(role => groupedByCategory[role]);
    ...
    <div>
      ...
      <div className="dashboard-container">
        ...
        <div className="top-section">
          ...
          <Link to={'/SSABS/admin/allusers'}>
            <button className="top-box top-box-2">All Users</button>
          </Link>
          <Link to={'/SSABS/admin/alltransaction'}>
            <button className="top-box top-box-3">All  transaction</button>
          </Link>
        ...
        <div className="middle-section">
          <div className="middle-box" data-aos="fade-up">
            <h3>Total Content by all users</h3>
            <Pie data={pieData} />
          </div>
          <div className="middle-box" data-aos="fade-up">
