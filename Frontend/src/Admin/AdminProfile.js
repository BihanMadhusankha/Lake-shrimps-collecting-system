...
var AdminProfile = function () {
    ...
    var _c = useState({}), editedAdmin = _c[0], setEditedAdmin = _c[1];
    useEffect(function () {
        var fetchAdminProfile = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.error('Error fetching admin data:', error_1);
                        return [3 /*break*/, 3];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios.put('http://localhost:5001/SSABS/profile', editedAdmin, {
                            headers: {
                                Authorization: "Bearer ".concat(token),
                            },
                        })];
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error('Error updating admin data:', error_2);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
    ...
    var handleInputChange = function (e) {
        ...
        setEditedAdmin(__assign(__assign({}, editedAdmin), (_a = {}, _a[name] = value, _a)));
    };
    return (React.createElement("div", null,
        React.createElement(AdminNav, null),
        React.createElement("div", { style: { textAlign: 'center', margin: '50px' } },
            React.createElement("h1", { style: { color: '#333', fontSize: '32px', marginBottom: '20px' } }, "Profile"),
            admin ? (React.createElement("div", { style: {
                ...
                React.createElement("div", { style: { marginBottom: '10px' } },
                    React.createElement("input", { type: "text", name: "firstname", value: editedAdmin.firstname, onChange: handleInputChange, style: { marginBottom: '10px', padding: '5px', width: '100%', borderRadius: '4px' } })),
                React.createElement("div", { style: { marginBottom: '10px' } },
                    React.createElement("input", { type: "text", name: "lastname", value: editedAdmin.lastname, onChange: handleInputChange, style: { marginBottom: '10px', padding: '5px', width: '100%', borderRadius: '4px' } })),
                React.createElement("div", { style: { marginBottom: '10px' } },
                    React.createElement("input", { type: "text", name: "email", value: editedAdmin.email, onChange: handleInputChange, style: { marginBottom: '10px', padding: '5px', width: '100%', borderRadius: '4px' } })),
                React.createElement("div", { style: { marginBottom: '10px' } },
                    React.createElement("input", { type: "text", name: "phone", value: editedAdmin.phone, onChange: handleInputChange, style: { marginBottom: '10px', padding: '5px', width: '100%', borderRadius: '4px' } })),
