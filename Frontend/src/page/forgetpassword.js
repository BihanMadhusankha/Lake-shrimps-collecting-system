    ...
    var handleForgotPassword = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios.post('http://localhost:5001/SSABS/user/forgetpassword', { email: email })];
                case 2:
                    response = _a.sent();
    ...
    return (React.createElement(Card, { className: 'form-container col-12 ', "align-items-center": true },
        React.createElement(Flex, { gap: "large" },
            React.createElement(Flex, { vertical: true, flex: 1 },
                React.createElement(Typography.Title, { level: 3, className: 'title' }, "Forgot Password"),
                React.createElement(Typography.Text, { type: 'secondary', strong: true, className: 'slogan' }, "Reset your account password"),
                React.createElement(Form, { layout: 'vertical' },
                    React.createElement(Form.Item, { label: 'Email', name: 'email', rules: [
                            { required: true, message: 'Please input your email!' },
                            { type: 'email', message: 'The input is not valid E-mail!' }
                        ] },
                        React.createElement(Input, { placeholder: 'Enter your Email', size: 'large', value: email, onChange: function (e) { return setEmail(e.target.value); } })),
                    React.createElement(Form.Item, null,
                        React.createElement(Button, { onClick: handleForgotPassword, className: 'btn', size: 'large' }, "Send Reset Email")))),
