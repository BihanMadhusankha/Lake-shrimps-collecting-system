...
var UserHome = function () {
        ...
        var checkTokenValidity = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios.get('http://localhost:5001/SSABS/user/userhome', {
                                headers: {
    ...
    return (React.createElement("div", null, isLoggedIn && (React.createElement(React.Fragment, null,
        React.createElement(UserNavigation, null),
        React.createElement(UsersLAnding, null)))));
};
