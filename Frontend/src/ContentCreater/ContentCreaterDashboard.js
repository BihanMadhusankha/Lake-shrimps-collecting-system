...
var ContentCreaterDashboard = function () {
        ...
        var checkTokenValidity = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios.get('http://localhost:5001/SSABS/vehicale_owner/dashboard', {
                                headers: {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { className: "dashboard-container" },
            ...
            React.createElement("header", { className: "header" },
                React.createElement("h1", null, "Content Creater Dashboard")),
            React.createElement("div", { className: "top-section" },
                ...
                React.createElement(Link, { to: '/SSABS/contentcreater/uploadedpost' },
                    React.createElement("button", { className: "top-box top-box-2" }, "Uploaded Content")),
                React.createElement(Link, { to: '/SSABS/instructer/uploadfile' },
                    React.createElement("button", { className: "top-box top-box-3" }, "Upload Content"))),
